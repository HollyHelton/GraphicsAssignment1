...
void init(GLWrapper *glw)
{
	...
	try
	{
		program = glw->LoadShader("src/shaders/lab3start.vert", "src/shaders/lab3start.frag");
	}
	catch (exception &e)
	{
...
/* Called whenever the window is resizedg The new window size is given, in pixels. */
